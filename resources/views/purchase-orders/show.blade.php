...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .po-title { font-size: 1.5rem; font-weight: 700; color: var(--text-dark); display: flex; align-items: center; gap: 12px; }
        .po-meta { margin-top: 6px; font-size: 0.875rem; color: var(--text-muted); }
